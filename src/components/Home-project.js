        ...
        <div class="projects__content">
          <div class="projects__row">
            ...
            <div class="projects__row-content">
              <h3 class="projects__row-content-title">Audit Kurir</h3>
              ...
              <a
                href="/akur"
                id="project-akur"
                class="btn btn--med btn--theme dynamicBgClr btn-11"
                target="_blank"
                >Lihat</a
              >
            </div>
          ...
          <div class="projects__row">
            ...
            <div class="projects__row-content">
              <h3 class="projects__row-content-title">Kasbaik by Kitabisa</h3>
              <p class="projects__row-content-desc">
